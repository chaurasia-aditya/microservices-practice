...
import com.chauri.accounts.dto.ResponseDto;
...
@Tag(
        ...
        description = "CRUD REST APIs for Accounts microservice to create/fetch/update/delete account details"
)
@RestController
...
public class AccountController {
    ...
    public ResponseEntity<ResponseDto> deleteAccountDetails(@RequestParam @Pattern(regexp = "(^$|\\d{10})", message = "Mobile number must be 10 digits")
                                                                String mobileNumber){
    ...
    @Operation(
            ...
            description = "Get build info of account micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version of account micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact info of account micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
