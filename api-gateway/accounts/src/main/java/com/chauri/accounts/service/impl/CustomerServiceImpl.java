...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber, String correlationId) {
        ...
        customerDetailsDto.setCardDto(cardsFeignClient.fetchCardDetails(correlationId, mobileNumber).getBody());
        customerDetailsDto.setLoanDto(loansFeignClient.fetchLoanDetails(correlationId, mobileNumber).getBody());
