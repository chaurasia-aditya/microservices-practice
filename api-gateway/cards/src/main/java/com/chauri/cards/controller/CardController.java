...
public class CardController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardDto> fetchCardDetails(@RequestHeader("bank-correlation-id") String correlationId,
                                                    @RequestParam
                                                    @Pattern(regexp = "(^$|\\d{10})", message = "Mobile number must be 10 digits")
                                                    String mobileNumber) {
    ...
    @Operation(
            ...
            description = "Get build info of cards micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version of cards micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact info of cards micro-service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
