package com.chauri.accounts.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleCustomerExistsException(CustomerExistsException customerExistsException,
